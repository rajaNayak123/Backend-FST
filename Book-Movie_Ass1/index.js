...
// Sample arrays of books and movies
const books = [
    {
        ...
        if(bookmovie=="books"){
            if(name==undefined){
                result=books;
                  ...
                  result=books.filter((book)=>book.name.split(' ').join('').toLowerCase()===name.split(' ').join('').toLowerCase());
            }
        }
    else if (bookmovie=== "movies") {
        if(name==undefined){
            result=movies;
        }else{
            result=movies.filter((book)=>book.name.split(' ').join('').toLowerCase()===name.split(' ').join('').toLowerCase());
        }
       } 
    if(result.length!== 0) {
